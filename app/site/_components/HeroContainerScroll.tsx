...
// Static version of Card for SSR
const StaticCard: React.FC = () => {
  return (
    <div className="max-w-5xl -mt-20 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-6 bg-background rounded-[30px] shadow-2xl">
      <Image
        src="/assets/preview.png"
        alt="Banner preview"
        width={1200}
